package wdframework.constants.box;
...
public class BoxConstants  {
	...
	public static String Bookmark="New Bookmark";
	public static String GoogleDoc="New Google Doc";
	public static String GoogleSpreadsheet="New Google Spreadsheet";
	public static String WordDocument="New Word Document";
	public static String PowerPointDocument="New PowerPoint Document";
	public static String ExcelSpreadsheet="New Excel Spreadsheet";

	public static String Download="Download";

	public static String MODownload="download";
	public static String MOShare="sharebar";
	public static String MOTag="tag";
	public static String MOMove="move";
	public static String MORestore="restore";
	public static String MODelete="delete_me";
