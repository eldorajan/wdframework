package wdframework.constants.googledrive;
...
public class GoogleDriveConstants  {
	...
	public static String LoggedInHeader="My Drive - Google Drive";
	public static String LoggedOutHeader="Sign in - Google Accounts";
	public static String MyDrive="My Drive";
